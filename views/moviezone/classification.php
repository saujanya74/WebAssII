<?php require 'moviezone_nav.php'; ?>
	<div class="content">
		<h1>Search by Classification</h1>
		
		<div class="searchbox">
			<form method="post">
				<label>Select Classification</label>
				<select name="txtClassificationID">
					<option value=""></option>
					<?php foreach ($this->classificationlist as $classification) {
		...
		<?php 
			if(isset($_POST['btnSubmit'])): 
				...
				if($_POST['txtClassificationID'] != ''):
					echo "<div class='page-info'>";
					echo "<h3 class='h3-people'>Classification: <span>".$_POST['txtClassificationID']."</span></h3>";
		?>
