	...
	<div class="content">
		...
		<div class="searchbox">
			<form method="post">
				...
				<select name="txtDirectorID">
					<option value=""></option>
					<?php foreach ($this->directorlist as $director) {
						extract($director);
					?>
					<option value="<?php echo $director_id ?>"><?php echo $director_name ?></option>
					<?php 
					} 
					?>
				</select>
		...
		<?php 
			if(isset($_POST['btnSubmit'])): 
				...
				if($_POST['txtDirectorID'] > 0):
					echo "<div class='page-info'>";
					echo "<h3 class='h3-people'>Director: <span>".$this->directorname['director_name']."</span></h3>";
		?>
