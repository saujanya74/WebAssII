	...
	<div class="content">
		...
		<div class="searchbox">
			<form method="post">
				...
				<select name="txtActorID">
					<option value=""></option>
					<?php foreach ($this->actorlist as $actor) {
						extract($actor);
					?>
					<option value="<?php echo $actor_id ?>"><?php echo $actor_name ?></option>
					<?php 
					} 
					?>
				</select>
		...
		<?php 
			if(isset($_POST['btnSubmit'])): 
				...
				if($_POST['txtActorID'] > 0):
					echo "<div class='page-info'>";

					echo "<h3 class='h3-people'>Actor: <span>".$this->actorname['actor_name']."</span></h3>";
		?>
