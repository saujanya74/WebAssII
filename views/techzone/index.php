	...
	<div class="content">
		...
		<h3>Articles</h3>
		<ul>
			<a href=""><li>What CMS Does Your Business Need? (August 2015)</li></a>
			<a href=""><li>Which Web Server Is Best For You? (June 2015)</li></a>
		</ul>
		<h4>What CMS Does Your Business Need?</h4>
		<p class="para">August 2015</p>
		<p><b>W</b>hile it is easy to develop a static web site for your business the task of developing a site that can handle dynamic content such as blog posts, social networking, ecommerce, and customer support is much harder. It would also be very expensive to develop such software in-house. This is why many businesses use a content management system to drive their websites.</p>
		<p><b>A</b> content management system is software which takes content stored in a database and transforms it for display as a web page. They allow non-technical staff to make updates through web based editing forms, with no knowledge required as to how the system actually stores or transforms the content. In addition the presentation of your content (such as the web site theme) can be changed without having to manually update a large number of web pages. Apart from their value in managing simple web site content these systems can be extended to handle tasks like ecommerce, customer relationship management, supply chain management, and enterprise resource planning.</p>
		<p><b>I</b>n this article we will look at four CMS systems Wordpress, XXXX, XXX, and XXXX comparing and contrasting their features and pricing.</p>
		<p><b>W</b>ordpress is the web’s most popular content management system, with an estimated 60% of the CMS market (w3techs.com 2014). Wordpress was created in 2003 and was originally designed to be a blogging platform (Tiwari 2014). Development over the years has expanded it into a general purpose CMS (Calao 2012).</p>
		<p><b>M</b>uch more required for this article ......</p>
		<p><b>W</b>ord count: XXXX</p>
		<h4>References</h4>
